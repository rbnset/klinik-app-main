<x-filament-panels::page>
    ...
    @if ($role === 'admin')
        ...
        {{-- ==== CARD STATISTIK (Tampilan seperti contoh gambar) ==== --}}
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4 mb-6">
            ...
            {{-- Total Pendaftaran --}}
            <div class="bg-white shadow rounded-xl p-5 text-center hover:shadow-md transition">
                <x-heroicon-o-clipboard-document-list class="mx-auto text-orange-500 mb-3" style="width:32px; height:32px;" />
    ...
    @elseif(in_array($role, ['pemilik', 'petugas']))

        <livewire:dashboard />

    @else
        <div class="text-center py-10">
            <p class="text-gray-600 text-lg">Selamat Datang di Praktek Mandiri Bidan Puji Susanti.</p>
        </div>
    @endif
</x-filament-panels::page>
